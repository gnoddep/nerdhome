...
class AlarmClock(Application):
    ...
    def initialize(self):
        self.__display = Display_SevenSegment(self.__display_handler, address=self.configuration.get('SevenSegment', 'i2c_address', default=0x77))
    ...
    def __display_handler(self, display):
        display.clear()
